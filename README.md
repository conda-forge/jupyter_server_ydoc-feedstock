...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/jupyter_server_ydoc-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/jupyter_server_ydoc-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add jupyter_server_ydoc
# for installing globally
pixi global install jupyter_server_ydoc
```
...
It is possible to list all of the versions of `jupyter_server_ydoc` available on your platform:
...
```
pixi search jupyter_server_ydoc --channel conda-forge
```
